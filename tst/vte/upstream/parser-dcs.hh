...
_VTE_SEQ(XTERM_RQTCAP, DCS, 'q', NONE, 1, PLUS, 0 ) /* xterm request termcap/terminfo */
...
_VTE_NOQ(DECAUPSS, DCS, 'u', NONE, 1, BANG, 0 ) /* assign user preferred supplemental sets / report */
