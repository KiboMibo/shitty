...
- EscapeSequenceParser — первые 67 из 161 теста текущего upstream учтены в
  `tests/test_xtermjs_escape_sequence_parser.py` (68 public tests проходят на
  обоих Ragel backend); остаются 94 теста.
