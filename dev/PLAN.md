...
- EscapeSequenceParser — первые 88 из 161 теста текущего upstream учтены в
  `tests/test_xtermjs_escape_sequence_parser.py` (89 public tests проходят на
  обоих Ragel backend); остаются 73 теста.
