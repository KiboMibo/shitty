...
Остались `tty-keys`, `tty-draw-line`, `input-keys`, mouse, theme report и
window ops. В основном это oracle tmux, а не терминала; использовать их лучше
как real-world streams.
