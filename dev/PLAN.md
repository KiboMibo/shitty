...
- EscapeSequenceParser — первые 109 из 161 тестов текущего upstream учтены в
  `tests/test_xtermjs_escape_sequence_parser.py` (110 public tests проходят на
  обоих Ragel backend); остаются 52 теста.
