...
u32 VulkanPresenter::findMemoryType(u32 allowed, VkMemoryPropertyFlags properties) const {
...
void VulkanPresenter::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& memory) const {
...
VulkanPresenter::ImageResource VulkanPresenter::createImage(u32 width, u32 height, u32 layers, VkFormat format, VkImageUsageFlags usage, bool arrayView) {
...
void VulkanPresenter::ensureCellBuffer(FrameResources& frame, size_t bytes) {
...
void VulkanPresenter::ensureGraphemeBuffer(FrameResources& frame, size_t bytes) {
...
void VulkanPresenter::recordCommands(FrameResources& frame, u32 imageIndex, const CharVdev& charVdev, const Frame& sourceFrame, bool delta) {
    VkCommandBufferBeginInfo beginInfo{};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    beginInfo.flags = VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT;
...
void VulkanPresenter::recordRepaintCommands(FrameResources& frame, u32 imageIndex) {
    VkCommandBufferBeginInfo beginInfo{};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    beginInfo.flags = VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT;
    checkVk(vkBeginCommandBuffer(frame.commandBuffer, &beginInfo), "vkBeginCommandBuffer");
...
bool VulkanPresenter::acquirePresentFrame(u32 width, u32 height, FrameResources*& frame, u32& imageIndex, bool& recreateAfterPresent) {
...
bool VulkanPresenter::submitPresentFrame(u32 width, u32 height, FrameResources& frame, u32 imageIndex, bool recreateAfterPresent) {
...
bool VulkanPresenter::present(const CharVdev& charVdev, const Frame& sourceFrame, bool delta) {
