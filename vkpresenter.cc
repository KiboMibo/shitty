...
namespace zutty {
    ...
    void
    VulkanPresenter::destroyImage(ImageResource& image) {
    ...
    void
    VulkanPresenter::createFontResources(Fontpack* fontpk) {
    ...
    void
    VulkanPresenter::createDescriptors() {
    ...
    void
    VulkanPresenter::updateStaticDescriptors() {
    ...
    void
    VulkanPresenter::updateOutputDescriptors() {
    ...
    void
    VulkanPresenter::updateCellDescriptor(FrameResources& frame) {
    ...
    void
    VulkanPresenter::createPipeline() {
    ...
    void
    VulkanPresenter::createOutputImage(uint32_t width, uint32_t height) {
        destroyImage(outputImage);
    ...
    void
    VulkanPresenter::ensureCellBuffer(
    ...
    bool
    VulkanPresenter::sameSelection(const Rect& lhs, const Rect& rhs) {
        return lhs.tl == rhs.tl && lhs.br == rhs.br &&
               lhs.rectangular == rhs.rectangular;
    }

    void
    VulkanPresenter::recordCommands(
    ...
    bool
    VulkanPresenter::present(const CharVdev& charVdev, bool delta) {
