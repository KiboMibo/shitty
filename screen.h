...
struct Screen {
    ...
    virtual void writeAsciiLines(u16 row, const u8* input, size_t size, u16 lineCount, const TerminalCell& attrs, u32 hyperlink, u32 semantic, const TerminalCell& eraseAttrs) = 0;
