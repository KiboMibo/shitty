            ...
            while (readLine(controlScheduler, controlFd, buffered, lineBytes)) {
                ...
                try {
                    if (startsWith(line, StringView(u8"WRITE "))) {
                        ...
                        writeParts(controlFd, StringView(u8"OK fontsize="), (i64)(composer.opts->fontsize), StringView(u8" border="), (i64)(composer.opts->border), StringView(u8" columns="), (i64)(composer.opts->nCols), StringView(u8" rows="), (i64)(composer.opts->nRows), StringView(u8" save_lines="), (i64)(composer.opts->saveLines), StringView(u8" fg="), (i64)(packedColor(composer.opts->fg)), StringView(u8" bg="), (i64)(packedColor(composer.opts->bg)), StringView(u8" cr="), (i64)(packedColor(composer.opts->cr)), StringView(u8" alt_scroll="), (i64)(composer.opts->altScrollMode), StringView(u8" bold_colors="), (i64)(composer.opts->boldColors), StringView(u8" auto_copy="), (i64)(composer.opts->autoCopyMode), StringView(u8" allow_osc52_read="), (i64)(composer.opts->allowOsc52Read), StringView(u8" allow_window_ops="), (i64)(composer.opts->allowWindowOps), StringView(u8" maximized="), (i64)(composer.opts->maximized), StringView(u8" no_decorations="), (i64)(composer.opts->noDecorations), StringView(u8" transparent_titlebar="), (i64)(composer.opts->transparentTitlebar), StringView(u8" quick="), (i64)(composer.opts->quick), StringView(u8" quick_geometry_w_percent="), (i64)(composer.opts->quickGeometry.width.percent), StringView(u8" quick_geometry_w="), (i64)(composer.opts->quickGeometry.width.value), StringView(u8" quick_geometry_h_percent="), (i64)(composer.opts->quickGeometry.height.percent), StringView(u8" quick_geometry_h="), (i64)(composer.opts->quickGeometry.height.value), StringView(u8" quick_geometry_x_percent="), (i64)(composer.opts->quickGeometry.x.percent), StringView(u8" quick_geometry_x="), (i64)(composer.opts->quickGeometry.x.value), StringView(u8" quick_geometry_y_percent="), (i64)(composer.opts->quickGeometry.y.percent), StringView(u8" quick_geometry_y="), (i64)(composer.opts->quickGeometry.y.value), StringView(u8"\n"));
