...
первой панели возможно точное утверждение. По ширине проверяется «не ноль», а
точное совпадение ширины проверяется у панели, рождённой сплитом: ей после
рождения никто размер не менял.
