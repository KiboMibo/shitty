...
struct ParserIface {
    ...
    virtual void csi_ED(u32 mode) = 0;
    virtual void csi_EL(u32 mode) = 0;
    virtual void csi_DECSED(u32 mode) = 0;
    virtual void csi_DECSEL(u32 mode) = 0;
    virtual void csi_DECSCA(u32 mode) = 0;
    ...
    virtual void csi_DECCARA(CsiRectangle rectangle, u32 mode, bool reverse) = 0;
    ...
    virtual void csi_TBC(u32 mode) = 0;
    virtual void csi_SM(u32 mode) = 0;
    virtual void csi_RM(u32 mode) = 0;
    virtual void csi_privSM(u32 mode) = 0;
    virtual void csi_privRM(u32 mode) = 0;
    virtual void csi_privSave(u32 mode) = 0;
    virtual void csi_privRestore(u32 mode) = 0;
    virtual void csi_ecma48_SL(u32 count) = 0;
    virtual void csi_ecma48_SR(u32 count) = 0;
    virtual void csi_DECSCUSR(u32 style) = 0;
    ...
    virtual void xtPushTitle(u32 target) = 0;
    virtual void xtPopTitle(u32 target) = 0;
    virtual void xtResizeRows(u32 rows) = 0;
    virtual void csi_XTTITLEMODE(u32 mode, bool set, bool reset) = 0;
    virtual void csi_XTHIMOUSE(u32 start, u32 startX, u32 startY, u32 firstRow, u32 lastRow) = 0;
    virtual void csi_DECELR(u32 mode, u32 units) = 0;
    virtual void csi_DECSLE(u32 operation) = 0;
    virtual void csi_DECRQLP() = 0;
    virtual void csi_DECEFR(u32 top, u32 left, u32 bottom, u32 right) = 0;
    virtual void csi_XTMODKEYS(u32 resource, u32 value, bool valuePresent, bool reset) = 0;
    virtual void csi_XTQMODKEYS(u32 resource) = 0;
    virtual void csi_kittyKeyboardPush(u32 flags) = 0;
    virtual void csi_kittyKeyboardPop(u32 count) = 0;
    virtual void csi_kittyKeyboardSet(u32 flags, u32 mode) = 0;
    virtual void csi_kittyKeyboardQuery() = 0;
    virtual void csi_DECRQM(u32 mode, bool privateMode) = 0;
    ...
    virtual void csi_DECLL(u32 operation, bool final) = 0;
