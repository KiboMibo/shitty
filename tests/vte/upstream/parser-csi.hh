...
_VTE_SEQ(SL, CSI, '@', NONE, 1, SPACE, 0 ) /* scroll left */
_VTE_SEQ(CUU, CSI, 'A', NONE, 0, NONE, 0 ) /* cursor up */
_VTE_SEQ(SR, CSI, 'A', NONE, 1, SPACE, 0 ) /* scroll right */
...
_VTE_NOQ(MINTTY_SD, CSI, 'T', NONE, 1, PLUS, 0 ) /* mintty unscroll */
...
_VTE_SEQ(DA2, CSI, 'c', GT, 0, NONE, 0 ) /* secondary device attributes / report */
...
_VTE_SEQ(DECSGR, CSI, 'm', WHAT, 0, NONE, 0 ) /* DEC select graphics rendition */
...
_VTE_SEQ(DSR_DEC, CSI, 'n', WHAT, 0, NONE, 0 ) /* DEC device status report */
...
_VTE_SEQ(XTERM_VERSION, CSI, 'q', GT, 0, NONE, 0 ) /* request xterm version report */
...
_VTE_SEQ(DECCARA, CSI, 'r', NONE, 1, CASH, 0 ) /* change attributes in rectangular area */
...
_VTE_NOQ(DECTLTC, CSI, 's', WHAT, 1, SQUOTE, 0 ) /* set transmit line termination character */
...
_VTE_SEQ(DECSLPP_OR_XTERM_WM, CSI, 't', NONE, 0, NONE, 0 ) /* set lines per page or xterm window management / report */
_VTE_NOQ(DECSWBV, CSI, 't', NONE, 1, SPACE, 0 ) /* set warning bell volume */
_VTE_NOQ(DECSRFR, CSI, 't', NONE, 1, DQUOTE, 0 ) /* select refresh rate */
_VTE_SEQ(DECRARA, CSI, 't', NONE, 1, CASH, 0 ) /* reverse attributes in rectangular area */
...
_VTE_SEQ(DECRQDE, CSI, 'v', NONE, 1, DQUOTE, 0 ) /* request display extent */
_VTE_SEQ(DECCRA, CSI, 'v', NONE, 1, CASH, 0 ) /* copy rectangular area */
_VTE_NOQ(WYCAA, CSI, 'w', NONE, 0, NONE, 0 ) /* redefine character display attribute association */
_VTE_SEQ(DECRQPSR, CSI, 'w', NONE, 1, CASH, 0 ) /* request presentation state report */
_VTE_NOQ(DECEFR, CSI, 'w', NONE, 1, SQUOTE, 0 ) /* enable filter rectangle */
_VTE_NOQ(DECSPP, CSI, 'w', NONE, 1, PLUS, 0 ) /* set port parameter */
_VTE_SEQ(DECREQTPARM_OR_WYCDIR, CSI, 'x', NONE, 0, NONE, 0 ) /* terminal parameters request / report or set current character attributes */
_VTE_SEQ(DECFRA, CSI, 'x', NONE, 1, CASH, 0 ) /* fill rectangular area */
_VTE_NOQ(DECES, CSI, 'x', NONE, 1, AND, 0 ) /* enable session */
_VTE_SEQ(DECSACE, CSI, 'x', NONE, 1, MULT, 0 ) /* select attribute change extent */
...
_VTE_SEQ(DECERA, CSI, 'z', NONE, 1, CASH, 0 ) /* erase rectangular area */
...
_VTE_SEQ(DECSERA, CSI, '{', NONE, 1, CASH, 0 ) /* selective erase rectangular area */
_VTE_NOQ(DECSTGLT, CSI, '{', NONE, 1, PCLOSE, 0 ) /* select color lookup table */
_VTE_NOQ(DECSZS, CSI, '{', NONE, 1, COMMA, 0 ) /* select zero symbol */
_VTE_NOQ(DECTTC, CSI, '|', NONE, 0, NONE, 0 ) /* set transmit termination character */
_VTE_NOQ(DECTTCX, CSI, '|', WHAT, 0, NONE, 0 ) /* set transmit termination character extended */
_VTE_SEQ(XTERM_REPORTSGR, CSI, '|', NONE, 1, HASH, 0 ) /* xterm SGR report */
...
_VTE_SEQ(DECIC, CSI, '}', NONE, 1, SQUOTE, 0 ) /* insert column */
...
_VTE_SEQ(DECDC, CSI, '~', NONE, 1, SQUOTE, 0 ) /* delete column */
